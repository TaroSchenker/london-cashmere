      ...
      <div className="bg-white p-large rounded shadow-lg w-96">
        ...
        <form>
          ...
          <div className="mb-medium">
            ...
            <input className="p-small w-full border rounded" type="password" id="password" placeholder="Enter your password" />
          </div>
          <button type="submit" className="w-full bg-primary-color text-text-color p-small rounded mb-medium hover:bg-secondary-color">Login</button>
        </form>
        <div className="text-center">
          <p className="text-neutral-dark">Don't have an account? <Link to="/user/register" className="text-primary-color hover:text-secondary-color">Sign Up</Link></p>
        </div>
      </div>
    </div>
  );
