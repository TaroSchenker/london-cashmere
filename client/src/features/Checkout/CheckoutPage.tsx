...
const CheckoutPage: React.FC = () => {
    ...
    return (
        <div className="p-8 bg-background-color font-serif">
            <h2 className="text-4xl mb-12 font-semibold text-neutral-dark">Checkout</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div className="mb-8 p-8 border border-gray-200 rounded-lg bg-white">
                        <div className="flex items-center mb-6">
                            <FontAwesomeIcon icon={faUser} className="mr-4 text-2xl text-neutral-dark"/>
                        ...
                        <form>
                            ...
                            <div className="mb-4">
                                ...
                                <input className="mt-1 p-2 w-full border rounded-md" type="email" />
                            </div>
                            {/* ... Other form inputs ... */}
                        </form>
                    </div>
                    ...
                    <div className="p-8 border border-gray-200 rounded-lg bg-white">
                        <div className="flex items-center mb-6">
                            <FontAwesomeIcon icon={faCreditCard} className="mr-4 text-2xl text-neutral-dark"/>
                ...
                <div>
                    ...
                    <div className="p-8 border border-gray-200 rounded-lg bg-white">
                        <div className="flex items-center mb-6">
                            <FontAwesomeIcon icon={faShoppingBag} className="mr-4 text-2xl text-neutral-dark"/>
                            <h3 className="text-2xl font-bold">Order Summary</h3>
                        </div>
                        <ul>
                            {cartProducts!.map(product => (
                                <li key={product._id} className="mb-4 flex justify-between text-neutral-dark">
                                    <span className="text-lg">{product.name} (x{product.quantity})</span>
                                    <span className="font-bold text-xl">£{product.price * product.quantity}</span>
                                </li>
                            ))}
                        </ul>
                        <div className="mt-8 border-t border-gray-200 pt-8">
                            <span className="text-2xl font-extrabold">Total Amount: £{totalAmount}</span>
                        </div>
                    </div>
                </div>
            </div>
