  ...
  const CartPage: React.FC<CartSidebarProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            >
            <div className="flex flex-col h-full py-6 px-5 pb-16"> {/* Added padding at the bottom */}
    ...
    <li key={index} className="mb-6 border-b pb-4 flex space-x-4 items-start">
        ...
        <div className="flex-grow">
            ...
            <div className="flex justify-between items-center">
                ...
                <div>
                    <span className="text-sm font-semibold">Total: £{product.price * product.quantity}</span>
                </div>
            </div>
        </div>
    </li>
                ...
                <div className="border-t pt-4 mt-auto">
                    ...
                    <Link to='/checkout' className="w-full bg-black text-white py-2 px-6 rounded-lg hover:border-black hover:bg-transparent hover:text-black border border-transparent transition-colors duration-300 font-medium text-xl">
                        Checkout
                    </Link>
                </div>
            </div>
