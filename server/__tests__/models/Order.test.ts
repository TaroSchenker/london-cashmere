...
describe("Order Model", () => {
  ...
  test("create & save order successfully", async () => {
    ...
    expect(savedOrder.customerDetails.name).toBe(
      mockOrder.customerDetails.name
    );
    expect(savedOrder.customerDetails.email).toBe(
      mockOrder.customerDetails.email
    );
    expect(savedOrder.customerDetails.address).toBe(
      mockOrder.customerDetails.address
    );
